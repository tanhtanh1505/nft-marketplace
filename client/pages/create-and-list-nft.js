...
export default function CreateItem() {
  ...
  async function onChange(e) {
    ...
    try {
      ...
      const url = `https://tanhuet.infura-ipfs.io/ipfs/${added.path}`;
      console.log("url", url);
      setFileUrl(url);
    } catch (error) {
    ...
    boredPetsContract.methods
      ...
      .on("receipt", function (receipt) {
        ...
        marketPlaceContract.methods
          .listNft(boredPetsContractAddress, tokenId, Web3.utils.toWei(formInput.price, "ether"))
